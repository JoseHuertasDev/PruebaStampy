...
require_once './libs/dependency.injector.php';
...
class Route {
    ...
    public function run(){
        ...
        $method = $this->method;
        $params = $this->params;
        //Resolvemos este controller mediante DI para que se le inyecten todas sus dependencia
        DependencyInjectorEngine::resolve($controller)->$method($params);
    }
}
